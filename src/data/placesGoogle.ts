 ...
 * Cost strategy: Nearby list stays on its own field mask. Text-to-pin is
 * LocationIQ (/api/geocode). Rating, hours, and photos load from Place Details
 * (/api/places-card) when a searched place is opened or saved — not Text Search.
 */
